...
class VirtualFileKotlinClass private constructor(
    ...
    companion object Factory {
        ...
        fun create(file: VirtualFile, fileContent: ByteArray?): KotlinClassFinder.KotlinClassOrClassFileContent? {
                ...
                try {
                    ...
                    if (!byteContent.isEmpty()) {
                        ...
                        return@time kotlinJvmBinaryClass?.let(::KotlinClass)
                            ?: KotlinClassFinder.KotlinClassOrClassFileContent.ClassFileContent(byteContent)
                    }
                }
