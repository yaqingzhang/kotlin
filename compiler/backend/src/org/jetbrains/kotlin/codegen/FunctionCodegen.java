...
public class FunctionCodegen {
    ...
    public static void generateParameterAnnotations(
        ...
        if (!AsmUtil.IS_BUILT_WITH_ASM6 && syntheticParameterCount > 0) {
            throw new RuntimeException("183 Bunch should be used!");
            //int indexForParamterAnnotation = kotlinParameterTypes.size() - syntheticParameterCount;
            //mv.visitAnnotableParameterCount(indexForParamterAnnotation, true);
            //mv.visitAnnotableParameterCount(indexForParamterAnnotation, false);
        }
    }
