...
dependencies {
    ...
    compileOnly("kotlin.build.custom.deps:intellij-core:${rootProject.extra["versions.intellijSdk"]}") {
        artifact {
            name = "intellij-core"
            type = "jar"
            extension = "jar"
...
agp25.compileClasspath += configurations.compile + agp25CompileOnly + sourceSets.getByName("main").output
