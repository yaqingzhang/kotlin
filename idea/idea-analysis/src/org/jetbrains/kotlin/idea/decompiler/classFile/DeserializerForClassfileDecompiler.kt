...
class DirectoryBasedClassFinder(
    ...
    override fun findKotlinClassOrClassFileContent(javaClass: JavaClass) = findKotlinClassOrClassFileContent(javaClass.classId!!)

    override fun findKotlinClassOrClassFileContent(classId: ClassId): KotlinClassFinder.KotlinClassOrClassFileContent? {
