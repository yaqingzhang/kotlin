...
class GradleFacetImportTest : GradleImportingTestCase() {
    ...
    fun testCommonImportByPlatformPlugin_SingleModule() {
        doTest("idea/testData/gradle/facets/commonImportByPlatformPlugin_SingleModule.gradle")
    ...
    fun testAndroidGradleJsDetection() {
        doTest("idea/testData/gradle/facets/androidGradleJsDetection.gradle")
    ...
    fun testKotlinAndroidPluginDetection() {
        doTest("idea/testData/gradle/facets/kotlinAndroidPluginDetection.gradle")
    ...
    fun testNoFacetInModuleWithoutKotlinPlugin() {
        doTest("idea/testData/gradle/facets/noFacetInModuleWithoutKotlinPlugin.m1.gradle")
    ...
    fun testClasspathWithDependenciesImport() {
        doTest("idea/testData/gradle/facets/classpathWithDependenciesImport.gradle")
    ...
    fun testDependenciesClasspathImport() {
        doTest("idea/testData/gradle/facets/dependenciesClasspathImport.gradle")
    ...
    fun testImplementsDependency() {
        doTest("idea/testData/gradle/facets/implementsDependency.gradle")
    ...
    fun testImplementsDependencyWithCustomSourceSets() {
        doTest("idea/testData/gradle/facets/implementsDependencyWithCustomSourceSets.gradle")
